...
public class Sequence implements Iterable<Integer> {
  ...
  /**
   * determines whether a user's input is valid based on the instructions provided in the 
   * console-based UI
   * @param userCommand an array of all of the characters in the user's input to be verified
   * @return true if there is a problem in the input, and false otherwise
   */
